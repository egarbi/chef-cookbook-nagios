...
client\_mysql
-------------
Install custom nrpe.d conf file(mysql.cfg) for mysql check in Nimbuzz

client\_ejabberd
----------------
Install custom nrpe.d conf files and scripts (ejabberd home) for ejabberd monitoring
Data Bags
=========
